...
export async function onStartChatting(
  ...
  We do have live chat feature, IMPORTANT - If user asks that he wants to talk to a executive or person, then add this line at the end "("end of the conversation")
